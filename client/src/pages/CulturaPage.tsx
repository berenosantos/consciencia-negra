        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-8">
            {cultureData.map((item) => (
              ...
              >
                <div className="rounded-lg border-2 border-[#4169E1] p-8 hover:shadow-lg transition h-full flex flex-col bg-white">
                  <h3 className="text-2xl font-bold mb-2 text-[#4169E1] group-hover:text-[#FFD700] transition">
